...
public class GuiClipboard extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        switch (button0state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 26, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 25, 72, 194, 16, 15);
                break;
            }
        }
        switch (button1state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 41, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 40, 72, 194, 16, 15);
                break;
            }
        }
        switch (button2state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 56, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 55, 72, 194, 16, 15);
                break;
            }
        }
        switch (button3state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 71, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 70, 72, 194, 16, 15);
                break;
            }
        }
        switch (button4state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 86, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 85, 72, 194, 16, 15);
                break;
            }
        }
        switch (button5state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 101, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 100, 72, 194, 16, 15);
                break;
            }
        }
        switch (button6state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 116, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 115, 72, 194, 16, 15);
                break;
            }
        }
        switch (button7state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 131, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 130, 72, 194, 16, 15);
                break;
            }
        }
        switch (button8state) {
            case 1: {
                this.drawTexturedModalRect(var5 + 30, 146, 51, 195, 16, 12);
                break;
            }
            case 2: {
                this.drawTexturedModalRect(var5 + 29, 145, 72, 194, 16, 15);
                break;
            }
        }
